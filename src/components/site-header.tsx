  ...
  return <>
    ...
    <header className="site-header">
      <div className="container nav-wrap">
        <Link className="brand" href="/" aria-label="Global Education and Careers home"><span className="brand-mark">GEC</span><span className="brand-copy"><strong>Global Education</strong><small>& Careers</small></span></Link>
