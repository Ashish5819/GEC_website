...
export function SiteFooter() {
  return <footer className="site-footer">
    <div className="container footer-grid">
      <div><div className="footer-logo"><Image src="/images/gec-logo.webp" alt="Global Education & Careers" width={82} height={82}/></div><p>Global Education & Careers</p><p className="muted-light">Thoughtful overseas education and career guidance is being planned from Hyderabad. (D)</p></div>
