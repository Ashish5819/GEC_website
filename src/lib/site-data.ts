...
const explicit: Record<string, PageData> = {
  ...
  "/about/founder": { path: "/about/founder", eyebrow: "Founder", title: "Meet Dr. Abbas Ali", intro: "Dr. Abbas Ali is the owner of Global Education & Careers. A fuller approved biography and professional profile will be published after verification. (D)" },
